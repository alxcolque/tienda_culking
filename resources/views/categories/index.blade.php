...
@section('content')
    <div class="container">
        <div class="p-4 rounded">
            <form class="row" action="{{route('categories.index')}}" method="GET">
                @csrf
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    <div class="input-group ">
                        <input type="search" name="search" value="{!!old('search', $search ?? '')!!}" class="form-control" placeholder="Buscar categorias...">
